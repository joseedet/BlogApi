        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResetTokenExpira = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikesPost", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LikesPost_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikesComentario", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LikesComentario_Comentarios_ComentarioId",
                        column: x => x.ComentarioId,
                        principalTable: "Comentarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LikesComentario_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LikesComentario_ComentarioId",
                table: "LikesComentario",
                column: "ComentarioId");

            migrationBuilder.CreateIndex(
                name: "IX_LikesComentario_UsuarioId",
                table: "LikesComentario",
                column: "UsuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_LikesPost_PostId",
                table: "LikesPost",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_LikesPost_UsuarioId",
                table: "LikesPost",
                column: "UsuarioId");
